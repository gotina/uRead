...
/** Gets a readonly {@link Iterator} of these results
@return A readonly {@link Iterator} of these results
*/	public Iterator<SearchResult> iterator() { return toList().iterator(); }

 /** Gets a readonly {@link List} of these results
@return A readonly {@link List} of these results
*/	public List<SearchResult> toList() { if( null == readonly ) { readonly = Collections.unmodifiableList( results ); }; return readonly; }
...
*/	public String toString() {
	...
	private List<SearchResult> readonly;
}
